...
import br.com.sabrina.sgt.gerador.Gerador07CapaCDTCC;
...
@RestController
@CrossOrigin("*")
@RequestMapping("/gerador/capacdtcc")
public class Gerador07CapaCDTCCController {

	@Autowired
	protected TCCsService tccService;
	
	@Autowired
	private Gerador07CapaCDTCC gerador;
	...
	public @ResponseBody byte[] gera(@PathVariable("idTCC") Long idTCC, 
		...
		try {
			...
			Dto07CapaCDTCC dto = new Dto07CapaCDTCC();
