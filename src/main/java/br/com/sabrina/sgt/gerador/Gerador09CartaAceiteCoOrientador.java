...
@Component
public class Gerador09CartaAceiteCoOrientador {

	public File gera(Dto09CartaAceiteCoOrientador dto) {
		try {
			File templateOriginal = new ClassPathResource("static/09_CARTA_ACEITE_COORIENTADOR_PREPROJETO.docx").getFile();
