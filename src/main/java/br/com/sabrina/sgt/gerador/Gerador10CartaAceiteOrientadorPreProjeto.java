...
@Component
public class Gerador10CartaAceiteOrientadorPreProjeto {

	public File gera(Dto10CartaAceiteOrientadorPreProjeto dto) {
		try {
			File templateOriginal = new ClassPathResource("static/10_CARTA_ACEITE_ORIENTADOR_PREPROJETO.docx").getFile();
